...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Manifold\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Manifold\\TypeCheck'), false);
    }
